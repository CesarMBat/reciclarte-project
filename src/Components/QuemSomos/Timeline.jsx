        ...
        <div>
            <main className='main-timeline main-margin'>
                <div className="div-timeline">
                    <div className='div-year' onMouseOver={() => mouseOver(1)} onMouseOut={mouseOut}>
                        <p className="p-timeline">2016</p>

                    </div>
                    <div className='div-year' onMouseOver={() => mouseOver(2)} onMouseOut={mouseOut}>
                        <p className="p-timeline">2017</p>
                    </div>
                    <div className='div-year' onMouseOver={() => mouseOver(3)} onMouseOut={mouseOut}>
                        <p className="p-timeline">2019</p>

                    </div>
                    <div className='div-year' onMouseOver={() => mouseOver(4)} onMouseOut={mouseOut}>
                ...
                <div className='div-p-time'>
                    ...
                    {show == 4 && (
                        <p className='p4'>Líder em decoração com materiais reciclados</p>
                    )}
                </div>
