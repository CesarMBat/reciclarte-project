        ...
        <div className="div-index">
          ...
          <div className={`show-div ${show ? "teste" : ""}`}>
            <p className="p-showing">
              A RECICL&#39;ARTE é uma empresa que presta serviços de decoração
              com materiais reciclados, podemos oferecer diversos produtos que
              deixarão seu local de escolha mais agradável.
            </p>
          </div>
        </div>
